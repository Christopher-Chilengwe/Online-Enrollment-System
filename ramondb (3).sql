...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2018 at 12:54 PM
...
INSERT INTO `class` (`CLASS_ID`, `CLASS_CODE`, `SUBJ_ID`, `INST_ID`, `SYID`, `DAY`, `TIME`, `IDNO`) VALUES
(1, '', 1, 0, 0, '', '00:00:00', 0),
(2, '', 1, 0, 0, '', '00:00:00', 0),
(3, '', 1, 0, 0, '', '00:00:00', 0),
(4, '', 1, 0, 0, '', '00:00:00', 0),
...
INSERT INTO `grades` (`GRADE_ID`, `IDNO`, `STUDENTNAME`, `SUBJ_ID`, `DESCRIPTION`, `INST_ID`, `INST_NAME`, `SYID`, `AY`, `SEMESTER`, `SECTION`, `FIN_AVE`, `REMARKS`) VALUES
(1, 20004425, 'Pintuan, John kenneth', 21, 'Bible and Salvation History ', 0, '', 0, '2018-2019', 'SECOND', '', 0, ''),
(2, 20004425, 'Pintuan, John kenneth', 22, 'Study and Thinking Skills ', 0, '', 0, '2018-2019', 'SECOND', '', 0, ''),
(3, 20001057, 'Salazar, Evan Lloyd', 11, 'Faith and Creed and Basic Catholic DoctDrine', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(4, 20001057, 'Salazar, Evan Lloyd', 12, 'English Plus ', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(5, 20001057, 'Salazar, Evan Lloyd', 13, 'Developmental Reading', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(6, 20004623, 'Balico, Sharah Mae', 11, 'Faith and Creed and Basic Catholic DoctDrine', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(7, 20004623, 'Balico, Sharah Mae', 12, 'English Plus ', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(8, 20004623, 'Balico, Sharah Mae', 13, 'Developmental Reading', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(9, 20004623, 'Balico, Sharah Mae', 14, 'Faith and Creed and Basic Catholic Doctrine', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(10, 20004623, 'Balico, Sharah Mae', 15, 'Philippine History and Culture', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(11, 20004623, 'Balico, Sharah Mae', 16, 'General Psychology with Moral Regen & Drug Abuse Ed.', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(12, 20004623, 'Balico, Sharah Mae', 17, 'General and Organic Chemistry', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(13, 20004623, 'Balico, Sharah Mae', 18, 'Introduction to Philosophy', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(14, 20004407, 'Martisano, John Mark', 19, 'Physical Education', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(15, 20004407, 'Martisano, John Mark', 283, 'Seminar on Problem Solving', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(16, 20001057, 'Salazar, Evan Lloyd', 14, 'Faith and Creed and Basic Catholic Doctrine', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(17, 20001057, 'Salazar, Evan Lloyd', 15, 'Philippine History and Culture', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(18, 20001057, 'Salazar, Evan Lloyd', 16, 'General Psychology with Moral Regen & Drug Abuse Ed.', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(19, 20001057, 'Salazar, Evan Lloyd', 17, 'General and Organic Chemistry', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(20, 20001057, 'Salazar, Evan Lloyd', 18, 'Introduction to Philosophy', 0, '', 0, '2018-2019', 'FIRST', '', 0, ''),
(21, 20001057, 'Salazar, Evan Lloyd', 20, 'NSTP', 0, '', 0, '2018-2019', 'FIRST', '', 0, '');
...
--
-- Dumping data for table `instructorssubjects`
--

INSERT INTO `instructorssubjects` (`INSSUBJ_ID`, `EMPID`, `INSTNAME`, `SUBJ_ID`, `SUBJDESCRPTION`, `AY`, `SEMESTER`) VALUES
(16, 123, 'Joean Mar Genit', 21, 'Bible and Salvation History ', '2018-2019', 'SECOND'),
(17, 123, 'Joean Mar Genit', 22, 'Study and Thinking Skills ', '2018-2019', 'SECOND'),
(19, 321, 'ANGELA RODRIGAZO', 13, 'Developmental Reading', '2018-2019', 'FIRST'),
(20, 321, 'ANGELA RODRIGAZO', 14, 'Faith and Creed and Basic Catholic Doctrine', '2018-2019', 'FIRST'),
(21, 321, 'ANGELA RODRIGAZO', 15, 'Philippine History and Culture', '2018-2019', 'FIRST'),
(22, 123, 'Joean Mar Genit', 12, 'English Plus ', '2018-2019', 'FIRST'),
(23, 123, 'Joean Mar Genit', 20, 'NSTP', '2018-2019', 'FIRST'),
(24, 123, 'Joean Mar Genit', 30, 'Liturgy and Sacraments in General', '2018-2019', 'FIRST');
...
(1, '2018-2019', 'SECOND', 21, 20004207, 'Registered', '2018-01-28 09:41:26', '0000-00-00 00:00:00', 'New', 'Amparado, lhenyl Grace'),
...
(6, 'SEMESTERFIRST', 'SEMESTER', 'FIRST', 'YES'),
(7, 'SEMESTERSECOND', 'SEMESTER', 'SECOND', 'NO'),
...
(1, 'TUITION', 1260, 20001057, '2018-2019', 'FIRST'),
(1, 'LABORATORIES', 1000, 20001057, '2018-2019', 'FIRST'),
(2, 'Journal', 50, 20001057, '2018-2019', 'FIRST'),
(3, 'recollection', 250, 20001057, '2018-2019', 'FIRST'),
(4, 'Others', 200, 20001057, '2018-2019', 'FIRST');
...
--
ALTER TABLE `instructorssubjects`
  MODIFY `INSSUBJ_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `tblassessment`
  MODIFY `ASSESSID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
